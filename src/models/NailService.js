...
const nailServiceSchema = new mongoose.Schema({
  nailTechnicianId: { type: mongoose.Schema.Types.ObjectId, ref: 'NailTechnician', required: true },
  catalogId: { type: mongoose.Schema.Types.ObjectId, ref: 'NailServiceCatalogItem' },
...
export default mongoose.model('NailService', nailServiceSchema);
