...
const lashServiceSchema = new mongoose.Schema({
  lashTechnicianId: { type: mongoose.Schema.Types.ObjectId, ref: 'LashTechnician', required: true },
  catalogId: { type: mongoose.Schema.Types.ObjectId, ref: 'LashServiceCatalogItem' },
...
export default mongoose.model('LashService', lashServiceSchema);
