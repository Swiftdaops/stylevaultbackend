...
const makeupServiceSchema = new mongoose.Schema({
  makeupArtistId: { type: mongoose.Schema.Types.ObjectId, ref: 'MakeupArtist', required: true },
  catalogId: { type: mongoose.Schema.Types.ObjectId, ref: 'MakeupServiceCatalogItem' },
...
export default mongoose.model('MakeupService', makeupServiceSchema);
