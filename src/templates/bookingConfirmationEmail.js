              ...
              <table role="presentation" cellspacing="0" cellpadding="0" style="margin-top:24px;">
                <tr>
                  <td align="center" bgcolor="#111111" style="border-radius:999px;">
                    <a href="${escapeHtml(manageLink)}" style="display:inline-block; padding:14px 24px; color:#ffffff; text-decoration:none; font-size:14px; font-weight:700;">Manage Appointment</a>
                  </td>
                </tr>
              </table>
            </td>
