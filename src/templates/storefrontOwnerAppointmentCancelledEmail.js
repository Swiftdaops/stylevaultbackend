...
export const storefrontOwnerAppointmentCancelledTemplate = ({
  customerName,
  customerEmail,
  providerName,
...
<head>
  ...
  <title>Appointment cancelled for ${escapeHtml(providerName)}</title>
</head>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px; background:#ffffff; border-radius:16px; overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px;">
              <div style="font-size:28px; line-height:1.2; font-weight:700; margin-bottom:12px;">${escapeHtml(customerName)} cancelled this booking</div>
              <div style="font-size:16px; line-height:1.7; color:#4b5563; margin-bottom:24px;">A booking on your ${escapeHtml(providerLabel.toLowerCase())} storefront has been cancelled. Cancelled by: ${escapeHtml(cancelledBy)}.</div>
                ...
                <tr>
                  <td style="padding:20px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      ...
                      ${summaryRow('Email', customerEmail || 'Not provided')}
                      ...
                      ${summaryRow('Location', location || 'Not specified')}
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" style="margin-top:24px;">
                  <tr>
                    <td align="center" bgcolor="#111111" style="border-radius:999px;">
                      <a href="${escapeHtml(dashboardLink)}" style="display:inline-block; padding:14px 24px; color:#ffffff; text-decoration:none; font-size:14px; font-weight:700;">Review appointments</a>
                    </td>
                  </tr>
                </table>
              ` : ''}
